...
from ..model import Country, City, CityTollFeeRate, VehicleTollFee as VehicleTollFeeModel
...
class VehicleTollFee:
    ...
    def get_city_country(self, country_id: int):
        return self.database_service.get_city_country(self.country_model, country_id)
    
    def get_city(self, city_id: int):
        return self.database_service.get_city(self.city_model, city_id)
